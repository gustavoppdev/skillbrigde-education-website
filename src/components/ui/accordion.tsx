...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        {children}
        <span className="bg-app-primary-95 hover:bg-app-primary-97 p-2 rounded">
          <Plus className="size-5 text-foreground transition-transform duration-300 group-data-[state=open]:rotate-45" />
        </span>
      </AccordionPrimitive.Trigger>
