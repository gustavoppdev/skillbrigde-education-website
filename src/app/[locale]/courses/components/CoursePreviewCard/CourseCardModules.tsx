...
const CourseCardModules = ({ course }: Props) => {
  ...
  return (
    <div className="rounded-[10px] border ">
      <h4 className="py-4 lg:py-5 px-5 lg:px-6 border-b  font-semibold lg:text-lg">
        {tt("curriculum")}
      </h4>
      ...
      <ul className="p-6 lg:p-10 flex flex-col lg:flex-row gap-5 lg:gap-10 justify-between">
        {course.modules.map((module) => (
          <li
            key={module.title}
            className="flex flex-col gap-3 border-b lg:border-b-0 last:border-b-0 pb-4 lg:border-r lg:last:border-r-0 lg:pr-4 "
          >
